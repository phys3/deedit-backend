...
export class InitialMigration1581790642803 implements MigrationInterface {
    name = 'InitialMigration1581790642803'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`
            CREATE TABLE "UserRole" (
                ...
                CONSTRAINT "UQ_8e689953af1d13b6964230defe2" UNIQUE ("name"), 
        ...
        await queryRunner.query(`
            CREATE TABLE "Tag" (
                ...
                "name" character varying(255) NOT NULL, 
                CONSTRAINT "PK_00bd1ec314f664289873394731a" PRIMARY KEY ("id")
            )`
        , undefined);
        ...
        await queryRunner.query(`
            CREATE TABLE "Like" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
                "userId" uuid NOT NULL, "postId" uuid NOT NULL,
                "vote" smallint NOT NULL,
                "createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
                "updatedAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, 
                CONSTRAINT "PK_20ede1755cb694ecf15674c8ba1" PRIMARY KEY ("id")
            )`
        , undefined);
        ...
        await queryRunner.query(`
            CREATE TABLE "User" (
                ...
                "createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
                "updatedAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
                CONSTRAINT "UQ_29a05908a0fa0728526d2833657" UNIQUE ("username"), 
        ...
        await queryRunner.query(`
            CREATE TABLE "UserToAchievement" (
                ...
                CONSTRAINT "PK_d2a104dd269cf18aac97c9ea721" PRIMARY KEY ("id")
            )`
        , undefined);
        ...
        await queryRunner.query(`
            CREATE TABLE "Achievement" (
                ...
                CONSTRAINT "UQ_52b363ef51eeff95391204b4ab8" UNIQUE ("name"),
                CONSTRAINT "PK_a71fcfebac220bdb07847d293d2" PRIMARY KEY ("id")
            )`
        , undefined);
